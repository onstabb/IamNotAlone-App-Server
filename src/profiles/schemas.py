...
from profiles.types import DateOfBirth, Age
from profiles import config as model_config
from profiles.enums import Gender, ResidenceLength, ResidencePlan
from geodata.types import CityGeonames
from geodata.basetypes import GeoPointType
...
class PrivateProfileIn(_ProfileBase):
    ...
    photo_urls: conlist(ImageHttpUrl, max_length=model_config.MAX_PROFILE_PHOTOS, min_length=1)
